...
En un espacio de tres dimensiones, los vectores forman un paralelepípedo. Representamos el sistema como una matriz de $3 \times 3$ y calculamos su determinante para obtener el volumen:
...
```{r graf_IV, echo=FALSE, warning=FALSE, message=FALSE}
library(plotly)
